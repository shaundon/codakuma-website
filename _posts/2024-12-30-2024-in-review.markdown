...
In February I released [SalaryPig](https://apps.apple.com/app/salarypig/id6475237479), an app for tracking your salary. It's pretty niche, but in December I started a new job and absolutely hated it from day one. I made SalaryPig as a way to console myself with the money that was coming in.
...
I added the ability to hide calorie-based facts from your workout stats, for people who don't want to see them for whatever reason.
